...
var examCheckBox = document.querySelectorAll('input[name="smallcategories[]"]');
var checkIncorrect = document.getElementById('randomExercise');
var record = document.getElementById('DisplayedNum');
checkIncorrect.addEventListener('click', function () {
  for (var i = 0; i < examCheckBox.length; i++) {
    examCheckBox[i].disabled = false;
